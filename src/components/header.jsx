...
function MenuIcon({onToggleMenu }){
    ...
    return(
        <div className="lg:hidden" onClick={onToggleMenu}>
            ...
            <svg width="24" height="18" xmlns="http://www.w3.org/2000/svg" className="duration-500 dark:fill-gray-950 fill-white"><path d="M24 16v2H0v-2h24zm0-8v2H0V8h24zm0-8v2H0V0h24z" /></svg>
        </div>
    )
}
...
function NavbarMobile({isOpen}) {
    ...
    return(
      ...
      <ul className={"lg:hidden flex flex-col gap-y-10  center items-center py-10 bg-white dark:bg-black w-[80%] absolute z-20 top-30 inset-x-0 mx-auto   barlow-semibold transition-transform duration-500 " + (!isOpen &&' hidden') }>
           ...
           <Button className="text-grey-55 dark:text-white">About</Button>
